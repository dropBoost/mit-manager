...
import { createSedeAction } from "../actions/aggiuntaSedeAction";
...
function SubmitButton() {
  ...
  return (
    <Button type="submit" disabled={pending} className="w-full gap-2 md:w-auto">
      ...
      {pending ? "Inserimento..." : "Inserisci sede"}
    </Button>
  );
}
...
export function FormSede({ franchisee = [], stati = [] }) {
  const [state, formAction] = useActionState(createSedeAction, initialState);
        ...
        <form action={formAction} className="space-y-8">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-12">
            <ComboboxField
              ...
              options={franchisee}
              required
              placeholder="Seleziona franchisee"
            ...
            <Field name="citta" label="Città" colspan="md:col-span-4" />

            <Field name="localita" label="Località" colspan="md:col-span-4" />
